...
def jsonfileupdate():
    ...
    with open("D:\\College Work\\AP Shah\\COMP\\Helped Aman\\Park It Down Project\\mysite\\main\\static\\mysite\\dash.json", "w") as f:
...
def parking_Details(response):
    ...
    if response.POST.get("book"):
        ...
        cardpickedprice = str(cardpickedprice)
        if len(cardpickedprice) == 4:
            cardpickedprice = cardpickedprice[0:1] + ',' + cardpickedprice[1:]
        elif len(cardpickedprice) == 5:
            cardpickedprice = cardpickedprice[0:2] + ',' + cardpickedprice[2:]
        elif len(cardpickedprice) == 6:
            cardpickedprice = cardpickedprice[0:1] + ',' + cardpickedprice[1:3] + ',' + cardpickedprice[3:]
        elif len(cardpickedprice) == 7:
            cardpickedprice = cardpickedprice[0:2] + ',' + cardpickedprice[2:4] + ',' + cardpickedprice[4:]
        elif len(cardpickedprice) == 8:
            cardpickedprice = cardpickedprice[0:1] + ',' + cardpickedprice[1:3] + ',' + cardpickedprice[3:5] + ',' + cardpickedprice[5:]
        elif len(cardpickedprice) == 9:
            cardpickedprice = cardpickedprice[0:2] + ',' + cardpickedprice[2:4] + ',' + cardpickedprice[4:6] + ',' + cardpickedprice[6:]
